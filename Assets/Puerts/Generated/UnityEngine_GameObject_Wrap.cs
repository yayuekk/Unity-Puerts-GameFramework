...
namespace PuertsStaticWrap
{
    public static class UnityEngine_GameObject_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_GetComponentCount(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.GameObject;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_GetComponentAtIndex(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.GameObject;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_GetComponentIndex(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.GameObject;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_SetGameObjectsActive(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_InstantiateGameObjects(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, typeof(int), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, typeof(int), false, false) && argHelper2.IsMatch(Puerts.JsValueType.NativeObject, typeof(Unity.Collections.NativeArray<int>), false, false) && argHelper3.IsMatch(Puerts.JsValueType.NativeObject, typeof(Unity.Collections.NativeArray<int>), false, false) && argHelper4.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.SceneManagement.Scene), false, false))
                
                    {
                        ...
                        var Arg2 = argHelper2.Get<Unity.Collections.NativeArray<int>>(false);
                    
                        var Arg3 = argHelper3.Get<Unity.Collections.NativeArray<int>>(false);
                    
                        var Arg4 = argHelper4.Get<UnityEngine.SceneManagement.Scene>(false);
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, typeof(int), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, typeof(int), false, false) && argHelper2.IsMatch(Puerts.JsValueType.NativeObject, typeof(Unity.Collections.NativeArray<int>), false, false) && argHelper3.IsMatch(Puerts.JsValueType.NativeObject, typeof(Unity.Collections.NativeArray<int>), false, false))
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_GetScene(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {   
                    ...
                    { new Puerts.MethodKey { Name = "GetComponentCount", IsStatic = false}, M_GetComponentCount },
                    { new Puerts.MethodKey { Name = "GetComponentAtIndex", IsStatic = false}, M_GetComponentAtIndex },
                    { new Puerts.MethodKey { Name = "GetComponentIndex", IsStatic = false}, M_GetComponentIndex },
                    ...
                    { new Puerts.MethodKey { Name = "SetGameObjectsActive", IsStatic = true}, F_SetGameObjectsActive },
                    { new Puerts.MethodKey { Name = "InstantiateGameObjects", IsStatic = true}, F_InstantiateGameObjects },
                    { new Puerts.MethodKey { Name = "GetScene", IsStatic = true}, F_GetScene }
                },
