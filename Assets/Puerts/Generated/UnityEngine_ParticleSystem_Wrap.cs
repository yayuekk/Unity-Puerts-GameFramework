...
namespace PuertsStaticWrap
{
    public static class UnityEngine_ParticleSystem_Wrap
    {
        ...
        private static void M_SetParticles(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.ParticleSystem.Particle[]), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, typeof(int), false, false) && argHelper2.IsMatch(Puerts.JsValueType.Number, typeof(int), false, false))
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NativeObject, typeof(Unity.Collections.NativeArray<UnityEngine.ParticleSystem.Particle>), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, typeof(int), false, false) && argHelper2.IsMatch(Puerts.JsValueType.Number, typeof(int), false, false))
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.ParticleSystem.Particle[]), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, typeof(int), false, false))
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NativeObject, typeof(Unity.Collections.NativeArray<UnityEngine.ParticleSystem.Particle>), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, typeof(int), false, false))
        ...
        private static void M_Simulate(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, typeof(float), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Boolean, typeof(bool), false, false) && argHelper2.IsMatch(Puerts.JsValueType.Boolean, typeof(bool), false, false) && argHelper3.IsMatch(Puerts.JsValueType.Boolean, typeof(bool), false, false))
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, typeof(float), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Boolean, typeof(bool), false, false) && argHelper2.IsMatch(Puerts.JsValueType.Boolean, typeof(bool), false, false))
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, typeof(float), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Boolean, typeof(bool), false, false))
        ...
        private static void M_Stop(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Boolean, typeof(bool), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, typeof(UnityEngine.ParticleSystemStopBehavior), false, false))
        ...
        private static void M_Emit(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.ParticleSystem.EmitParams), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, typeof(int), false, false))
        ...
        private static void M_TriggerSubEmitter(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, typeof(int), false, false) && argHelper1.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.ParticleSystem.Particle), true, false))
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, typeof(int), false, false) && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle>), false, false))
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_has3DParticleRotations(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.ParticleSystem;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_hasNonUniformParticleSizes(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.ParticleSystem;
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"has3DParticleRotations", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_has3DParticleRotations, Setter = null} },

                    {"hasNonUniformParticleSizes", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_hasNonUniformParticleSizes, Setter = null} },
