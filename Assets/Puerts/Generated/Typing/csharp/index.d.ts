...
declare module 'csharp' {
    ...
    namespace CSharp {
        ...
        type $Task<T> = System.Threading.Tasks.Task$1<T>
            class AddressablesBridge extends System.Object
            {
                protected [__keep_incompatibility]: never;
                public static LoadAssetAsync ($key: string) : UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle$1<UnityEngine.Object>
                public static InstantiateAsync ($key: string, $parent?: UnityEngine.Transform) : UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle$1<UnityEngine.GameObject>
                public static Release ($handle: any) : void
                public static ReleaseInstance ($go: UnityEngine.GameObject) : void
                public static LoadSceneAsync ($key: string, $loadMode: number) : UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle$1<UnityEngine.ResourceManagement.ResourceProviders.SceneInstance>
                public static UnloadSceneAsync ($sceneInstance: any) : UnityEngine.ResourceManagement.AsyncOperations.AsyncOperationHandle$1<UnityEngine.ResourceManagement.ResourceProviders.SceneInstance>
            }
        ...
        namespace UnityEngine {
            ...
            class GameObject extends UnityEngine.Object
            {
                ...
                /** Creates a GameObject with a primitive mesh renderer and appropriate collider. * @param type The type of primitive object to create.
                */
                ...
                */
                ...
                /** Is this GameObject tagged with tag ? * @param tag The tag to compare.
                */
                ...
                */
                ...
                /** Calls the method named methodName on every MonoBehaviour in this GameObject and on every ancestor of the behaviour. * @param methodName The name of the method to call.
                ...
                */
                ...
                /** Calls the method named methodName on every MonoBehaviour in this GameObject. * @param methodName The name of the method to call.
                * @param value An optional parameter value to pass to the called method.
                * @param options Should an error be raised if the method doesn't exist on the target object?
                */
            ...
            class MonoBehaviour extends UnityEngine.Behaviour
            {
                ...
                /** Invokes the method methodName in time seconds, then repeatedly every repeatRate seconds. * @param methodName The name of a method to invoke.
            ...
            class Vector2 extends System.ValueType implements System.IFormattable, System.IEquatable$1<UnityEngine.Vector2>
            {
                ...
                public static kEpsilonNormalSqrt : number/** Returns a normalized vector based on the current vector. The normalized vector has a magnitude of 1 and is in the same direction as the current vector. Returns a zero vector If the current vector is too small to be normalized. */
                ...
                */
                ...
                /** Reflects a vector off the surface defined by a normal. * @param inDirection The direction vector towards the surface.
            ...
            class Vector3 extends System.ValueType implements System.IFormattable, System.IEquatable$1<UnityEngine.Vector3>
            {
                ...
                public z : number/** Returns a normalized vector based on the current vector. The normalized vector has a magnitude of 1 and is in the same direction as the current vector. Returns a zero vector If the current vector is too small to be normalized. */
                ...
                */
                ...
                /** Reflects a vector off the plane defined by a normal. * @param inDirection The direction vector towards the plane.
            ...
            class Camera extends UnityEngine.Behaviour
            {
                ...
                public static kMinAperture : number/** The maximum allowed aperture. */
                public static kMaxAperture : number/** The minimum blade count for the aperture diaphragm. */
                public static kMinBladeCount : number/** The maximum blade count for the aperture diaphragm. */
                public static kMaxBladeCount : number/** Delegate that you can use to execute custom code before a Camera culls the scene. */
                ...
                */
                ...
                /** Returns a ray going from camera through a screen point. * @param pos A 3D point, with the x and y coordinates containing a 2D screenspace point in pixels. The lower left pixel of the screen is (0,0). The upper right pixel of the screen is (screen width in pixels - 1, screen height in pixels - 1). Unity ignores the z coordinate.
            ...
            class Shader extends UnityEngine.Object
            {
                ...
                */
                ...
                /** Returns the default int value of the shader property at the specified index. * @param propertyIndex The index of the shader property.
                */
            ...
            class Texture extends UnityEngine.Object
            {
                ...
                public static GenerateAllMips : number/** How many mipmap levels are in this Texture (Read Only). */
            ...
            class Material extends UnityEngine.Object
            {
                ...
                */
                ...
                /** Copies properties, keyword states and settings from mat to this material, but only if they exist in both materials. * @param mat The Material to copy from.
                */
                ...
                */
                ...
                /** Sets the lock state of a property for this material. * @param nameID Property name ID, use Shader.PropertyToID to get it.
                * @param name Property name, e.g. "_SrcBlend".
                * @param value The desired lock state.
                */
                public SetPropertyLock ($nameID: number, $value: boolean) : void
                /** Applies an override associated with a Material Variant to a target. * @param destination The Material to which the Editor applies the override.
                * @param nameID Property name ID, use Shader.PropertyToID to get it.
                * @param name Property name, e.g. "_SrcBlend".
                ...
                */
                ...
                /** Removes the override on a property. * @param nameID Property name ID, use Shader.PropertyToID to get it.
                * @param name Property name, e.g. "_SrcBlend".
                */
                ...
                */
                ...
                /** Sets a color value. * @param nameID Property name ID, use Shader.PropertyToID to get it.
                ...
                */
                ...
                /** Sets the placement offset of a given texture. The name parameter is defined in the shader. This method creates a new Material instance. * @param nameID Property name ID, use Shader.PropertyToID to get it.
                ...
                */
                ...
                /** Retrieves a list of the named properties in the material that match the input property type. * @param type The type to use to query the material for named properties.
                */
            ...
            class Sprite extends UnityEngine.Object
            {
                ...
                */
                ...
                /** Create a new Sprite object. * @param texture The Texture to obtain the Sprite graphic from.
            ...
            class Texture2D extends UnityEngine.Texture
            {
                ...
                */
                ...
                /** Sets the pixel color at coordinates (x,y). * @param x The x coordinate of the pixel to set. The range is 0 through (texture width - 1).
                ...
                */
                ...
                /** Sets the pixel colors of part of a mipmap level. * @param x The x coordinate to place the block of pixels at. The range is 0 through (texture width - 1).
                ...
                */
                ...
                /** Sets the pixel colors of an entire mipmap level. * @param colors The array of pixel colours to use. This is a 2D image flattened to a 1D array.
                * @param miplevel The mipmap level to write colors to. The range is 0 through the texture's Texture.mipmapCount. The default value is 0.
                */
                ...
                */
                ...
                /** Sets the raw data of an entire texture in CPU memory. * @param data The array of data to use.
                ...
                */
                ...
                /** Copies changes you've made in a CPU texture to the GPU. * @param updateMipmaps When the value is true, Unity recalculates mipmap levels, using mipmap level 0 as the source. The default value is true.
                ...
                */
                ...
                /** Reads pixels from the current render target and writes them to a texture. * @param source The region of the render target to read from.
            ...
            class AudioSource extends UnityEngine.AudioBehaviour
            {
                ...
                */
                ...
                /** Provides the block of audio frequencies (spectrum data) of the AudioSource that is currently playing. * @param samples The array to populate with frequency domain representations of audio samples. The array length must be a power of 2 (such as 128, 256, 512). Also, the length must not be less than 64 or greater than 8192.
                * @param channel The channel to sample from.
            ...
            class Resources extends System.Object
            {
                ...
                */
                ...
                /** Returns true if the given instance ID corresponds to a valid Object in memory. The Object could have been deleted or not loaded into memory yet. * @param instanceID ID of an Object.
                */
            ...
            class Application extends System.Object
            {
                ...
                */
                ...
                /** Opens the URL specified, subject to the permissions and limitations of your app’s current platform and environment.  * @param url The URL to open.
                */
        ...
        namespace GameFramework {
            class GameFramework extends UnityEngine.MonoBehaviour
            {
                protected [__keep_incompatibility]: never;
                public constructor ()
            }
        ...
        namespace GameFramework.UI {
            ...
            {
                protected [__keep_incompatibility]: never;
                public layer : GameFramework.UI.UILayer
            ...
            enum UILayer
            { Bottom = 0, Normal = 1, Queue = 2, Pop = 3, Top = 4 }
            class UIRoot extends UnityEngine.MonoBehaviour
            {
                protected [__keep_incompatibility]: never;
                public static get Instance(): GameFramework.UI.UIRoot;
                public get UICamera(): UnityEngine.Camera;
                public GetLayerRoot ($layer: GameFramework.UI.UILayer) : UnityEngine.Transform
                public GetLayerCanvas ($layer: GameFramework.UI.UILayer) : UnityEngine.Canvas
                public SetLayerBlocker ($layer: GameFramework.UI.UILayer, $visible: boolean) : void
                public static SetUIPanelDistance ($uiGo: UnityEngine.GameObject, $sortingOrder: number) : void
                public static GetUIConfig ($uiGo: UnityEngine.GameObject) : GameFramework.UI.UIConfig
                public constructor ()
            }
        }
        ...
        namespace UnityEngine.Networking {
            ...
            class UnityWebRequest extends System.Object implements System.IDisposable
            {
                ...
                /** Clears stored cookies from the cache. * @param uri An optional URL to define which cookies are removed. Only cookies that apply to this URL are removed from the cache.
                */
