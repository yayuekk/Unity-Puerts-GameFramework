...
namespace PuertsStaticWrap
{
    public static class UnityEngine_Resources_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_InstanceIDIsValid(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_InstanceIDsToValidArray(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var Arg1 = argHelper1.Get<Unity.Collections.NativeArray<bool>>(false);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {   
                    ...
                    { new Puerts.MethodKey { Name = "InstanceIDIsValid", IsStatic = true}, F_InstanceIDIsValid },
                    { new Puerts.MethodKey { Name = "InstanceIDsToValidArray", IsStatic = true}, F_InstanceIDsToValidArray }
                },
