...
namespace PuertsStaticWrap
{
    public static class UnityEngine_MonoBehaviour_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_destroyCancellationToken(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.MonoBehaviour;
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"destroyCancellationToken", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_destroyCancellationToken, Setter = null} },

                    {"useGUILayout", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_useGUILayout, Setter = S_useGUILayout} }
                },
                LazyMembers = new System.Collections.Generic.List<Puerts.LazyMemberRegisterInfo>()
                {   
                    new Puerts.LazyMemberRegisterInfo() { Name = "runInEditMode", IsStatic = false, Type = (Puerts.LazyMemberType)3, HasGetter = true, HasSetter = true }
                }
            };
        }
