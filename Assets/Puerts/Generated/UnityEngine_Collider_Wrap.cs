...
namespace PuertsStaticWrap
{
    public static class UnityEngine_Collider_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_providesContacts(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Collider;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_providesContacts(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Collider;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.providesContacts = argHelper.GetBoolean(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_layerOverridePriority(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Collider;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_layerOverridePriority(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Collider;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.layerOverridePriority = argHelper.GetInt32(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_excludeLayers(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Collider;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_excludeLayers(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Collider;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.excludeLayers = argHelper.Get<UnityEngine.LayerMask>(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_includeLayers(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Collider;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_includeLayers(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Collider;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.includeLayers = argHelper.Get<UnityEngine.LayerMask>(false);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"providesContacts", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_providesContacts, Setter = S_providesContacts} },

                    {"layerOverridePriority", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_layerOverridePriority, Setter = S_layerOverridePriority} },

                    {"excludeLayers", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_excludeLayers, Setter = S_excludeLayers} },

                    {"includeLayers", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_includeLayers, Setter = S_includeLayers} },
